...
extern "C" void fscio_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { fscio_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { fscio_assert(false, "strftime_l called"); }
