...
namespace  fscio {
    ...
    *  @ingroup cpp_api
    *  @brief Defines FSCIO Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         FSCLIB_SERIALIZE( row, (value) )
      };

      typedef fscio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            fscio::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
