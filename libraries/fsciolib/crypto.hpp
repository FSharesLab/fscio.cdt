...
namespace fscio {
   ...
   */
   ...
   struct public_key {
      ...
      FSCLIB_SERIALIZE( public_key, (type)(data) )
   };
   ...
   */
   ...
   struct signature {
      ...
      FSCLIB_SERIALIZE( signature, (type)(data) )
   };
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return fscio::checksum256 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return fscio::checksum160 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return fscio::checksum512 - Computed digest
    */
    ...
    *  @param sig - Signature
    *  @return fscio::public_key - Recovered public key
    */
