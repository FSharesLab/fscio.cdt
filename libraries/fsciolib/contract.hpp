 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every FSCIO contract
 * @{
 */
namespace fscio {

/**
 * @brief %Base class for FSCIO contract.
 * @details %Base class for FSCIO contract. %A new contract should derive from this class, so it can make use of FSCIO_ABI macro.
 */
class contract {
   public:
      /**
