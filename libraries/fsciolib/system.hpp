...
namespace fscio {
    ...
    *  @ingroup cpp_api
    *  @brief Defines wrappers over fscio_assert 
    *
    *  @{
    */
    ...
    *
    *  @code
    *  fscio::check(a == b, "a does not equal b");
    *  @endcode
    */
   inline void check(bool pred, const char* msg) {
      if (!pred) {
         fscio_assert(false, msg);
      }
   }
    ...
    *  fscio::check(a == b, "a does not equal b", 18);
    *  @endcode
    */
   inline void check(bool pred, const char* msg, size_t n) {
      if (!pred) {
         fscio_assert_message(false, msg, n);
      }
   }
    ...
    *  fscio::check(a == b, msg, 18);
    *  @endcode
    */
   inline void check(bool pred, const std::string& msg, size_t n) {
      if (!pred) {
         fscio_assert_message(false, msg.c_str(), n);
      }
   }
