 ...
 */
bool PPC::isVMRGFSChuffleMask(ShuffleVectorSDNode *N, bool CheckEven,
                              unsigned ShuffleKind, SelectionDAG &DAG) {
  if (DAG.getDataLayout().isLittleEndian()) {
...
SDValue PPCTargetLowering::LowerVECTOR_SHUFFLE(SDValue Op,
  ...
  if (V2.isUndef()) {
    if (PPC::isSplatShuffleMask(SVOp, 1) ||
        ...
        (Subtarget.hasP8Altivec() && (
         ...
         PPC::isVMRGFSChuffleMask(SVOp, true, 1, DAG) ||
         PPC::isVMRGFSChuffleMask(SVOp, false, 1, DAG)))) {
      return Op;
    }
  }
  ...
  if (PPC::isVPKUWUMShuffleMask(SVOp, ShuffleKind, DAG) ||
      ...
      (Subtarget.hasP8Altivec() && (
       ...
       PPC::isVMRGFSChuffleMask(SVOp, true, ShuffleKind, DAG) ||
       PPC::isVMRGFSChuffleMask(SVOp, false, ShuffleKind, DAG))))
    return Op;
