...
namespace PR10720 {
  ...
  struct pair2 {
    ...
    // CHECK-PR10720: define linkonce_odr {{.*}} @_ZN7PR107205pair2aSFSC0_
    // CHECK-PR10720: load
    // CHECK-PR10720: icmp ne
    // CHECK-PR10720-NEXT: br i1
    // CHECK-PR10720: call {{.*}} @_ZN7PR107201XaSFSC0_
    // CHECK-PR10720: ret
    ...
    // CHECK-PR10720-LABEL: define linkonce_odr void @_ZN7PR107205pair2C2FSC0_
    // CHECK-PR10720-NOT: ret
    // CHECK-PR10720: load
    // CHECK-PR10720: call void @_ZN7PR107201XC1FSC0_
    // CHECK-PR10720: icmp eq
    // CHECK-PR10720-NEXT: br i1
    // CHECK-PR10720: ret void
    pair2(pair2&&) = default;
