...
public:
  ...
  bool isFscioContract() const { return hasAttr<FscioContractAttr>(); }
  bool isFscioAction() const { return hasAttr<FscioActionAttr>(); }
  bool isFscioTable() const { return hasAttr<FscioTableAttr>(); }
  bool isFscioIgnore() const { return hasAttr<FscioIgnoreAttr>(); }
  bool hasFscioRicardian() const { return hasAttr<FscioRicardianAttr>(); }
  FscioActionAttr* getFscioActionAttr() const { return getAttr<FscioActionAttr>(); }
  FscioTableAttr*  getFscioTableAttr() const { return getAttr<FscioTableAttr>(); }
  FscioContractAttr*  getFscioContractAttr() const { return getAttr<FscioContractAttr>(); }
  FscioRicardianAttr*  getFscioRicardianAttr() const { return getAttr<FscioRicardianAttr>(); }
