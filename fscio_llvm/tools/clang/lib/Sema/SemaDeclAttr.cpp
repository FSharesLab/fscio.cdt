...
static void handleFscioRicardianAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
   ...
   D->addAttr(::new (S.Context)
                 FscioRicardianAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleFscioContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 FscioContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleFscioActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 FscioActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleFscioTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 FscioTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_FscioIgnore:
    handleSimpleAttribute<FscioIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_FscioAction:
    handleFscioActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_FscioTable:
    handleFscioTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_FscioContract:
    handleFscioContractAttribute(S, D, AL);
    break;
  case AttributeList::AT_FscioRicardian:
    handleFscioRicardianAttribute(S, D, AL);
    break;
