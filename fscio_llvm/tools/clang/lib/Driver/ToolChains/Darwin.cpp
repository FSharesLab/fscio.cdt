...
struct DarwinPlatform {
  ...
  void addOSVersionMinArgument(DerivedArgList &Args, const OptTable &Opts) {
    ...
    case DarwinPlatformKind::MacOS:
      ...
      break;
    case DarwinPlatformKind::IPhoneOS:
      Opt = options::OPT_miphonfsc_version_min_EQ;
      break;
    case DarwinPlatformKind::TvOS:
...
getDeploymentTargetFromOSVersionArg(DerivedArgList &Args,
  ...
  Arg *iOSVersion = Args.getLastArg(options::OPT_miphonfsc_version_min_EQ,
...
getDeploymentTargetFromEnvironmentVariables(const Driver &TheDriver,
  ...
  if (!Targets[Darwin::WatchOS].empty() &&
    ...
    TheDriver.Diag(diag::err_drv_conflicting_deployment_targets)
        << "WATCHOS_DEPLOYMENT_TARGET"
        << (!Targets[Darwin::IPhoneOS].empty() ? "IPHONFSC_DEPLOYMENT_TARGET"
                                               : "TVOS_DEPLOYMENT_TARGET");
  }
...
void Darwin::addMinVersionArgs(const ArgList &Args,
  ...
  if (isTargetWatchOS())
    ...
    CmdArgs.push_back("-iphonfsc_version_min");
  else {
