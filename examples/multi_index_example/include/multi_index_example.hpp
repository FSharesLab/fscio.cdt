...
CONTRACT multi_index_example : public contract {
   public:
      ...
      typedef fscio::multi_index<"testtaba"_n, test_table, fscio::indexed_by<"secid"_n, fscio::const_mem_fun<test_table, uint64_t, &test_table::by_secondary>>> test_tables;
