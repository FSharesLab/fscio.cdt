...
mkdir -p ${PROJECT}/${VERSION}/opt/fscio_cdt/lib/cmake
...
echo "class FscioCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/FutureSharesCloud/fscio.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/FutureSharesCloud/fscio.cdt/releases/download/v${VERSION}\"
