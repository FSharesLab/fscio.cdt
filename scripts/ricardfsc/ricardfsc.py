...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardfsc.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardfsc.py import /fsc/contracts/contract/mycontract.abi /fsc/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardfsc.py export /fsc/contracts/contract/mycontract.abi')
