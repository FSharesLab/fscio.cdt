# Purpose
The `ricardfsc.py` imports or exports Ricardian contracts to and from a contract's ABI file.

## Import Example
`$ python3 ricardfsc.py import /path/to/source-contract.abi /path/to/new-smart-contract-abi.abi`
...
## Export Example
`$ python3 ricardfsc.py export /path/to/source-contract.abi`
