if(FSCIO_CDT_ROOT STREQUAL "" OR NOT FSCIO_CDT_ROOT)
   set(FSCIO_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${FSCIO_CDT_ROOT}/lib/cmake/fscio.cdt)
if (NOT FSCIO_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(FSCIO_WASM_OLD_BEHAVIOR "On")
    include(FscioWasmToolchain)
endif()
...
function(FSCIO_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(FSCIO_CHECK_VERSION)
