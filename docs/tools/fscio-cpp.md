### Usage
---
To manually compile the source code, use `fscio-cpp/fscio-cc` and `fscio-ld` as if it were __clang__ and __lld__. All the includes and options specific to FSCIO and CDT are baked in.

###$ fscio-cpp
---
```
USAGE: fscio-cpp [options] <input file> ...
